...
function JQueryAccessibleTree_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleTree') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.cookie', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jstree-a11y/jsTree.v.1.0rc2/lib/jquery.cookie.js'));
        wp_enqueue_script('jquery.cookie');

        wp_register_script('jquery.hotkeys', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jstree-a11y/jsTree.v.1.0rc2/lib/jquery.hotkeys.js'));
        wp_enqueue_script('jquery.hotkeys');

        wp_register_script('jquery.jstree', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jstree-a11y/jsTree.v.1.0rc2/jquery.jstree.js'));
        wp_enqueue_script('jquery.jstree');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_script('JQueryAccessibleTree', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTree/lib/JQueryAccessibleTree.js'));
